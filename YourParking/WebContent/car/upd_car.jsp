...
<table border="1" style="border-collapse: collapse">
  <c:forEach items="${sessionScope.cars}" var="car">
    <tr>
      <th>CarName</th><th>CarHigh</th><th>CarWidth</th><th>CarLength</th><th>CarWeight</th><th>GroundHeight</th><th>Action</th><th>削除</th>
    </tr>
    <tr>
      ...
      <form action="DelCar.action" method="post">
